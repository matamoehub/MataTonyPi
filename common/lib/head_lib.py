...
def center(duration_ms: int = 300):
    ...
    return set_head(vertical=vertical, horizontal=horizontal, duration_ms=duration_ms)


def look_left(delta: int = 320, duration_ms: int = 280):
    vertical, horizontal = head_center()
    return set_head(vertical=vertical, horizontal=horizontal + int(delta), duration_ms=duration_ms)
...
def look_up(delta: int = 260, duration_ms: int = 280):
    vertical, horizontal = head_center()
    return set_head(vertical=vertical - int(delta), horizontal=horizontal, duration_ms=duration_ms)
